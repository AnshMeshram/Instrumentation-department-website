...
export default function About() {
  ...
  return (
    <div className="page-stack-tight pb-12">
      ...
      <section className="grid gap-4 md:grid-cols-3">
        {highlightCards.map((item) => {
          ...
          return (
            <Card
              key={item.title}
              className="border border-[var(--color-border)] bg-white shadow-[var(--shadow-soft)]"
            >
      ...
      <section className="grid gap-6 lg:grid-cols-3">
        {valuePoints.map((point) => {
          ...
          return (
            <Card
              key={point.title}
              className="border-none bg-white shadow-sm transition-all duration-300 hover:shadow-md group p-1"
            >
              <CardContent className="p-6 md:p-7">
                <div className="inline-flex rounded-full bg-[var(--color-primary-soft)] p-4 text-[var(--color-primary)] mb-6 transition-transform duration-500 group-hover:rotate-[360deg]">
      ...
      <section className="rounded-3xl border border-[var(--color-border)] bg-[var(--color-surface-soft)] px-6 py-12 md:px-8 shadow-sm overflow-hidden relative">
        ...
        <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between border-b border-[var(--color-border)] pb-10 relative">
          ...
          <Link
            to="/faculty"
            className="group inline-flex items-center gap-3 rounded-full bg-[var(--color-primary)] px-7 py-3.5 text-sm font-bold text-white transition-all hover:bg-[var(--color-primary-strong)] hover:shadow-xl hover:-translate-y-1 shrink-0"
          >
